...
const DriverDetails = () => {
  ...
  const { id, hour, capacity, state, school, driver, district, passengers } = location.state;
        ...
        <Card.Body>
          ...
          <Row>
            ...
            <Col md="auto" className="d-flex align-items-start">
              <hr className="vr" style={{ height: "100%", width: "2px", color: "#3f3f3f" }} />
            </Col>
          ...
          <Button className="mt-5 btn-details" onClick={clickHandler}>Volver atrás.</Button>
        </Card.Body>
      </Card>
    </div>
  );
